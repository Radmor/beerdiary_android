...
public class ExpandableListAdapterStyles extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapterStyles(Context context, List<String> listDataHeader,
        ...
        if (convertView == null) {
            ...
            lblListRemove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    builder.setMessage("Czy na pewno chcesz usunąć gatunek "+lblListHeader.getText()+"?").setPositiveButton("Tak", dialogClickListener)
